...
def get_arg():
    ...
    parser.add_argument('--random_seed',    type=int,   default=3407,   help='batch_size')
    parser.add_argument('--lr',             type=float, default=0.00002,  help='0.00001, 0.00003')

    parser.add_argument('--checkpoint_dir', default='checkpoints/pitvqa_cls',  help='path to checkpoint')
...
if __name__ == '__main__':
    ...
    folder_head = '/path/to/EndoVis-18-VQA/seq_'  # set your path
